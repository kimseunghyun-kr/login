...
//    usage of server.servlet.session.tracking-modes=cookie
//    in application.properties allows only cookies as the form of maintaining session
//    does not expose jsessionid on URL {happens when browser does not support cookies}
